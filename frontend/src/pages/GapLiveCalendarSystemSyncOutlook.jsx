...
// v0 scaffold for: No live calendar-system sync (Outlook, Google Calendar)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-live-calendar-system-sync-outlook/run.

export default function LiveCalendarSystemSyncOutlookPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-live-calendar-system-sync-outlook/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No live calendar-system sync (Outlook, Google Calendar)</h1>
