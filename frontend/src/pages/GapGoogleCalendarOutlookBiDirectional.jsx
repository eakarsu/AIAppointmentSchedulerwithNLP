...
// v0 scaffold for: Google Calendar and Outlook bi-directional sync
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-google-calendar-outlook-bi-directional/run.

export default function GoogleCalendarOutlookBiDirectionalPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-google-calendar-outlook-bi-directional/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Google Calendar and Outlook bi-directional sync</h1>
