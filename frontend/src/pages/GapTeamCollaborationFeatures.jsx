...
// v0 scaffold for: No team collaboration features
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-team-collaboration-features/run.

export default function TeamCollaborationFeaturesPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-team-collaboration-features/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No team collaboration features</h1>
