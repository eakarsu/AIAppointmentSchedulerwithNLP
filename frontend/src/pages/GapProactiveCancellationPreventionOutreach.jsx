...
// v0 scaffold for: Proactive cancellation-prevention outreach
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-proactive-cancellation-prevention-outreach/run.

export default function ProactiveCancellationPreventionOutreachPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-proactive-cancellation-prevention-outreach/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Proactive cancellation-prevention outreach</h1>
