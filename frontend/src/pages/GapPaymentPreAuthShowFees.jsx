...
// v0 scaffold for: Payment pre-auth for no-show fees
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-payment-pre-auth-show-fees/run.

export default function PaymentPreAuthShowFeesPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-payment-pre-auth-show-fees/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Payment pre-auth for no-show fees</h1>
