...
// v0 scaffold for: No payment collection or no-show fee charging
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-payment-collection-show-fee-charging/run.

export default function PaymentCollectionShowFeeChargingPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-payment-collection-show-fee-charging/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No payment collection or no-show fee charging</h1>
